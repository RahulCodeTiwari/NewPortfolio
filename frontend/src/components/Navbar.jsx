          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-3 w-40 rounded-xl border border-base bg-card shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all cursor-pointer">
                <a href="https://github.com/RahulCodeTiwari" target="_blank" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-base">
                  <i className="ri-github-fill"></i> GitHub
                </a>

                <a href="https://www.linkedin.com/in/rahul-tiwari-6a55b9229/" target="_blank" className="flex items-center gap-2 px-4 py-2 text-sm hover:bg-base">
          ...
          <div className="space-y-2 rounded-2xl border border-base bg-card/10 p-4 shadow-lg shadow-slate-900/20">
            {navLinks.map((n) => (
              <button
                key={n.id}
                onClick={() => scrollTo(n.id)}
                className={`w-full rounded-lg px-3 py-2 text-left text-lg ${active === n.id ? "bg-primary/10 text-slate-50" : "text-slate-300"
                  }`}
              >
            ...
            <div className="mt-4 flex justify-center gap-5 text-xl">
              <a href="https://github.com/RahulCodeTiwari" target="_blank"><i className="ri-github-fill"></i></a>
              <a href="https://www.linkedin.com/in/rahul-tiwari-6a55b9229/" target="_blank"><i className="ri-linkedin-box-fill"></i></a>
